...
import static com.glitss.teabreak_app.ModelClass.PermissionsChecker.REQUIRED_PERMISSION;
import static com.glitss.teabreak_app.ModelClass.PermissionsChecker.REQUIRED_PERMISSION132;
import static com.glitss.teabreak_app.Ui.PermissionsActivity.PERMISSION_REQUEST_CODE;
...
import com.glitss.teabreak_app.ModelClass.FileUtils;
import com.glitss.teabreak_app.ModelClass.OrderHistoryModel;
import com.glitss.teabreak_app.ModelClass.PermissionsChecker;
import com.glitss.teabreak_app.Utils.SaveAppData;
import com.glitss.teabreak_app.ViewModel.TeaBreakViewModel;
import com.glitss.teabreak_app.databinding.ActivityOrdersListBinding;
...
public class Orders_List_Activity extends AppCompatActivity {
    ...
    public static final String APPLICATION_ID = "com.glitss.teabreak_app";
...
//                            Snackbar.make(Orders_List_Activity.this,findViewById(android.R.id.content),"No Order List",Snackbar.LENGTH_LONG).show();
                            ...
                            binding.rvListItems.setVisibility(View.GONE);
                            binding.tvNoDataFound.setText("No Data Found");
                        }
                        else{
                            binding.tvNoDataFound.setVisibility(View.GONE);
                            binding.rvListItems.setVisibility(View.VISIBLE);
                        }
